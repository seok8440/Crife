...
<div class="search_table">
		<!-- 프로젝트 검색창 -->
 <form name="proSearch" id="proSearch" method="post">
...
$(document).ready(function() {
	...
	$("#searchBtn").click(function() {
		console.debug("click");
		document.getElementById('proSearch').action="${path}/admin/projectall.do";
		document.getElementById('proSearch').submit();
