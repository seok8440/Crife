...
<div class="mem_table1">
    <form name="memForm" id="memForm" method="post" action="${path}/admin/memList.do">
 ...
 <option value="mem_address" <c:if test="${map.memSearch=='mem_address'}">selected</c:if> >주소</option>
 </select>
...
[총 회원 ${memTotCount}명] 검색결과:<c:choose>
...
<td>${row.mem_email}</td>
<td>${row.mem_phone}</td>
<td><fmt:formatDate value="${row.mem_register_datetime}"
